            ...
            <!-- Notes & Summary -->
             <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
               ...
               <div class="bg-indigo-50/30 rounded-xl border border-indigo-100 p-4">
                 ...
                 <!-- Total Deviation (History Only) -->
                 <div v-if="isHistory && po.total_real" class="flex justify-between items-center mt-2 pt-2 border-t border-indigo-100/50">
                    <span class="text-[10px] font-bold text-slate-500">Deviasi Realisasi</span>
                    <span class="text-xs font-bold" :class="getDeviationClass(po.total_real, po.total_approved)">
                      {{ formatDeviation(po.total_real, po.total_approved) }}
                    </span>
                 </div>
               </div>
             </div>
